...
const { createLanguages, getPosts, getPost, addPost, deletePost, updatePost, getUserPosts, getPostBySlug, getPostsByCategory, createSlugs } = require('./controllers/post.controller');
// api/posts
router.get('/', getPosts);
...
router.put('/createLang', createLanguages);
router.post('/', addPost);
